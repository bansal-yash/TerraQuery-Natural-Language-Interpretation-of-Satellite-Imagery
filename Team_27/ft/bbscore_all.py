...
def load_finetuned_model(checkpoint_path: str, device="cuda"):
    ...
    base_model_name = "path/to/models--unsloth--Qwen3-VL-8B-Instruct/snapshots/11d38e30f7b6dec7545b704d119dc6fbecbbd639"  # Match your training script
...
def compare_models_batch(args):
    ...
    base_model_name = "path/to/qwen/models--unsloth--Qwen3-VL-8B-Instruct/snapshots/11d38e30f7b6dec7545b704d119dc6fbecbbd639"  # Match your training script
    ...
    base_model, base_processor = FastVisionModel.from_pretrained(
        "/path/to/qwen/models--unsloth--Qwen3-VL-8B-Instruct/snapshots/11d38e30f7b6dec7545b704d119dc6fbecbbd639",
        device_map="auto",  # Use auto device mapping
