...
def find_checkpoint_candidate() -> Optional[str]:
    ...
    """
    candidates = [
        "/home/samyak/scratch/interiit/band_classifier/checkpoint/best_model_3classes_450_all_data.pt",
        "band_classifier/checkpoint/best.pth",
        "band_classifier/checkpoint/checkpoint.pth",
        "band_classifier/checkpoint/epoch_latest.pth",
        "gaurav/checkpoint/checkpoint.pth",
    ]
    for c in candidates:
        if os.path.exists(c):
            return c
