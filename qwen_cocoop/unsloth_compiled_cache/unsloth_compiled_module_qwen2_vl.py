...
from typing import Any, List, Optional, Tuple, Union, Dict, Set, Callable
from transformers.models.qwen2_vl.modeling_qwen2_vl import (F, Any, Callable, Optional, Union, torch, nn, LayerNorm, ACT2FN, Cache, GenerationMixin, FlashAttentionKwargs, ROPE_INIT_FUNCTIONS, dynamic_rope_update, ALL_ATTENTION_FUNCTIONS, PreTrainedModel, Unpack, TransformersKwargs, can_return_tuple, is_torchdynamo_compiling, deprecate_kwarg, Qwen2VLTextConfig, Qwen2VLVisionConfig, logger, __name__, Qwen2VLModel, Qwen2VLCausalLMOutputWithPast, Qwen2VLPreTrainedModel, Qwen2VLForConditionalGeneration)
...
class Qwen2VLForConditionalGeneration(Qwen2VLPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        return Qwen2VLForConditionalGeneration_forward(self, input_ids, attention_mask, position_ids, past_key_values, inputs_embeds, labels, use_cache, output_attentions, output_hidden_states, pixel_values, pixel_values_videos, image_grid_thw, video_grid_thw, rope_deltas, cache_position, **kwargs)
